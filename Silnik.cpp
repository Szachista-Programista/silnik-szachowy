...
Silnik::Silnik(bool k): kolor{k}, aktualny{k}{//1
//==============================================================================================================
    try{
...
//#########################################################################
    ...
    T_wsk_szachownica Silnik::zainicjalizuj_szachownice(){//0+
//==============================================================================================================
    try{
...
Silnik::~Silnik()noexcept{
//==============================================================================================================
    delete[]wsk_szachownica_wyjsciowa;
    delete[]wsk_szachownica_robocza;
}
bool Silnik::czy_urzytkownik_moze_wykonac_takie_posuniecie(int posuniecie_urzytkownika){//*1
//==============================================================================================================
    try{
...
//#########################################################################
    ...
    void Silnik::rozszyfruj_posuniecie_urzytkownika(int posuniecie_urzytkownika){//0+
//==============================================================================================================
    try{
        ...
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
//#########################################################################
    }
    ...
    bool Silnik::czy_na_polu_wyjsciowym_jest_bierka_urzytkownika(){//0+
//==============================================================================================================
    try{
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
...
//#########################################################################
    ...
    bool Silnik::czy_na_polu_docelowym_jest_bierka_urzytkownika(){//0+
//==============================================================================================================
    try{
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
...
//#########################################################################
    ...
    bool Silnik::czy_ten_ruch_powoduje_wystawienie_swojego_krola_na_bicie(){//*0
//==============================================================================================================
    try{
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
...
//#########################################################################
    ...
    bool Silnik::czy_ruch_jest_zgodny_z_zasadami(){//*0
//==============================================================================================================
    try{
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
        if (m.zX < 0 || 7 < m.zX || m.zY < 0 || 7 < m.zY || m.naX < 0 || 7 < m.naX || m.naY < 0 || 7 < m.naY)
            throw invalid_argument("Wspolzedne ruchu maszyny poza zakresem.");
        if (wsk_szachownica_robocza == nullptr)
            throw invalid_argument("Zerowy adres szachownicy.");
        T_wsk_szachownica wsk_X = wsk_szachownica_robocza;
...
int Silnik::wykonaj_posuniecie(int posuniecie_urzytkownika){//2????
//==============================================================================================================
    try{
...
//#########################################################################
    ...
    void Silnik::przygotuj_maszyne_na_ruch(int posuniecie_urzytkownika){//1
//==============================================================================================================
    try{
...
//#########################################################################
        ...
        void Silnik::nanies_posuniecie_urzytkownika_na_szachownice(int posuniecie_urzytkownika){//0+
//==============================================================================================================
    try{
        if (u.zX < 0 || 7 < u.zX || u.zY < 0 || 7 < u.zY || u.naX < 0 || 7 < u.naX || u.naY < 0 || 7 < u.naY)
            throw invalid_argument("Wspolzedne ruchu urzytkownika poza zakresem.");
        if (wsk_szachownica_wyjsciowa == nullptr || wsk_szachownica_robocza == nullptr)
            throw invalid_argument("Zerowy adres szachownicy.");
        if(posuniecie_urzytkownika == 10000)
            return;
...
//==============================================================================================================
    ...
    switch(nr_ruchu_debiutowego)
    {
        ...
        case 2:
            if(kolor)
            {
                ...
                {
                    if(wsk_szachownica_robocza[7][6] = 'S')
                    {
                    ...
                    {
                        wykonaj_ruch_gry_srodkowej();
                        etap_gry = gra_wlasciwa;
                    }
                }
                else
                {
                    if(wsk_szachownica_robocza[7][1] = 'S')
                    {
        ...
        case 3:
            ...
            {
                if(wsk_szachownica_robocza[5][5] = 'S')
                {
    ...
    void Silnik::wykonaj_ruch_gry_srodkowej(){//*0
//==============================================================================================================
    try{
...
//==============================================================================================================
    ...
    int  Silnik::oblicz_posuniecie_maszyny()noexcept{
//==============================================================================================================
    ...
    return posuniecie_maszyny + czy_to_koniec_gry(); //zwraca ruch
        ...
        void Silnik::znajdz_posuniecie_maszyny()noexcept{
//==============================================================================================================
    if(wsk_szachownica_robocza == nullptr)
        return;
    ...
    if(czy_to_roszada == true)
    {
        ...
        int  Silnik::zaszyfruj_posuniecie_maszyny()noexcept{
//==============================================================================================================
    if(wsk_szachownica_robocza == nullptr)
        return 0;
    ...
    return m.zX*1000+m.zY*100+m.naX*10+m.naY*1 + kod_wypromowanej_bierki;
        ...
        void Silnik::nanies_posuniecie_maszyny_na_szachownice()noexcept{
//==============================================================================================================
    if(wsk_szachownica_robocza == nullptr)
        return;
    char ruszana_bierka;
    ...
    if(ruszana_bierka == 'K')//roszady byc moze
    {
        ...
        int  Silnik::czy_to_koniec_gry()noexcept{
//==============================================================================================================
